...
tmux select-pane -L -t pitted
tmux split-window -v -t pitted 'docker run -p 8084:8080 --net=mynet --ip=10.0.0.24 -e K=4 -e VIEW="10.0.0.21:8080,10.0.0.22:8080,10.0.0.23:8080,10.0.0.24:8080,10.0.0.25:8080,10.0.0.26:8080" -e "IPPORT"="10.0.0.24:8080" kvs'
